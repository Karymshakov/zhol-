      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between gap-2 mb-1">
            <h3 className="text-[15px] font-semibold text-text-main">{career.name}</h3>
          ...
          <p className="text-[12px] text-muted mb-2 leading-relaxed">{career.why}</p>
          <div className="flex flex-wrap gap-x-3 gap-y-0.5 text-[11px] text-muted mb-2">
            <span>💰 {career.salary}</span>
            <span>📚 ОРТ: {career.ort}</span>
          </div>
